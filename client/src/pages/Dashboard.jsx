          ...
          >
            <div className="bg-slate-800 mt-5 py-4 pl-10 md:mt-10">
              <span className="">
                ...
                <span className="text-xl">uth MERN</span>
              </span>
            </div>
            <ul className="mt-8 space-y-3 md:mt-20">
              ...
              <li className="relative">
                <button onClick={logOut} className="focus:bg-slate-600 hover:bg-slate-600 flex w-full space-x-2 rounded-md px-10 py-4 text-gray-300 focus:outline-none">
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6"
          ...
          <div className="h-full overflow-hidden pl-10">
            ...
            >
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-8">
                <div className="h-56 w-72 rounded-xl bg-white p-10 shadow-md" />
                <div className="h-56 w-72 rounded-xl bg-white p-10 shadow-md" />
